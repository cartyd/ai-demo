"""Grid view for RL pathfinding visualization."""
...
class GridView(QGraphicsView):
    """Graphics view for displaying and interacting with the RL grid."""
        ...
        for y in range(grid.height):
            for x in range(grid.width):
                ...
                if node:
                    ...
                    tile.set_show_q_values(self.show_q_values)
    ...
    def set_show_q_values(self, show: bool):
        """Enable or disable Q-value display on all tiles."""
        self.show_q_values = show
        for tile in self.tiles.values():
            tile.set_show_q_values(show)
